...
outdir = "{}/idefics3_pretrain_gen_{}_{}_mubf16".format(args.outdir, s, e)
...
for i in range(num_p):
    ...
    command = "{} -m vispec.ge_data.ge_data_all_idefics3_pretrain_gen --start={} --end={} --index={} --gpu_index {} --outdir {} --model {} --temperature {} --datapath {}".format(
        sys.executable,
        start,
        end,
        index,
