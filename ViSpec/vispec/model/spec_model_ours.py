...
from .modeling_idefics3_kv import (
    CustomIdefics3ForConditionalGeneration as KVIdefics3ForConditionalGeneration,
)
...
class SpecModel(nn.Module):
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        if Type == "LlamaForCausalLM":
            ...
            base_model = KVIdefics3ForConditionalGeneration.from_pretrained(
                base_model_path, **kwargs
            )
        else:
    ...
    def forward(
        ...
        **kwargs,
        ...
        if inputs_embeds is not None and self.base_model.config.architectures[0] in (
        ...
        **kwargs,
        ...
        if (
            ...
            if inputs_embeds is None:
                ...
                if pixel_values is not None:
                    image_hidden_states = self.base_model.model.get_image_features(
                    ...
                    n_image_features = (
                        image_hidden_states.shape[0] * image_hidden_states.shape[1]
                    )
                    if n_image_tokens != n_image_features:
                        raise ValueError(
                            f"Image features and image tokens do not match: tokens: {n_image_tokens}, features {n_image_features}"
                    ...
                    inputs_embeds = self.base_model.model.inputs_merger(
                        input_ids=input_ids,
                        inputs_embeds=inputs_embeds,
